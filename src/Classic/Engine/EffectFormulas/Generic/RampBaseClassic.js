...
const GLOBALCONST = {
    ...
    statPoints: {
        crit: 35,
        intCrit: 0, // The amount of crit chance you get from 1 point of intellect.
        haste: 32.79,
        leech: 21,
    }
...
export const getHaste = (stats) => {
    return 1 + stats.haste / GLOBALCONST.statPoints.haste / 100;
...
export const getSpellRaw = (spell, currentStats, specConstants) => {
    return (getSpellFlat(spell) + spell.coeff * currentStats.spellpower) * getStatMult(currentStats, spell.secondaries, spell.statMods || {}, specConstants); // Multiply our spell coefficient by int and secondaries.
}
